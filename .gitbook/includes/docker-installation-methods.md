---
title: Docker Installation Methods
---

{% tabs %}
{% tab title="Recommended Linux Installation" %}
```bash
...
> ### This script gives options for installing multiple items such as NGINX Proxy Manager, Portainer and more.
